...
export const MASTER_CATEGORIES: CategorySeed[] = [
  ...
  { name: "Zepto Cafe", slug: "food_junction", emoji: "🍔", color: "#EC4899", parentTab: "food", group: "Snacks & Drinks", subcategories: ["Burgers", "Pizza", "Momos", "Rolls", "Sandwiches", "Beverages"] },
  ...
  { name: "Sexual Wellness", slug: "sexual-wellness", emoji: "🔥", color: "#DC2626", parentTab: "swiftmart", group: "Beauty & Personal Care", subcategories: ["Condoms", "Lubricants", "Wellness Devices"] },
