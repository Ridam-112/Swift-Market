...
export default function Auth() {
  ...
  // true when coming from OTP-user detection (vs. explicit forgot-password)
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.needsPasswordSetup) {
        // Token was auto-generated by the backend — skip forgot-password step
        // and go straight to the create-password form.
        toast.info("Check the server console for your setup token, then create your password.");
        setResetPhone(phone);
        setResetToken("");
        setNewPassword("");
            ...
            <motion.div key="reset" variants={slideVariants} initial="initial" animate="animate" exit="exit"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold">
                    {isCreatingPassword ? "Create your password" : "Set New Password"}
                  </h2>
                  <p className="text-muted-foreground text-sm">
                    {isCreatingPassword
                      ? "Your setup token is in the server console"
              ...
              {isCreatingPassword && (
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-3 text-sm text-blue-800 dark:text-blue-300">
                  <p className="font-medium">Setup token generated</p>
                  <p className="text-xs mt-0.5">
                    A one-time setup token was printed in the server console (terminal).
                    Copy it below and create your password. It expires in 15 minutes.
                  </p>
                </div>
              )}
